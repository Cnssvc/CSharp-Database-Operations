...
namespace DataGridveritabanıişlemleri.ticaretDataSetTableAdapters {
    ...
    public partial class musteriTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[musteri] ([mno], [ad], [soyad], [dtarih], [tel]) VALUES (@mno," +
                " @ad, @soyad, @dtarih, @tel);\r\nSELECT mno, ad, soyad, dtarih, tel FROM musteri W" +
                "HERE (mno = @mno)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[musteri] SET [mno] = @mno, [ad] = @ad, [soyad] = @soyad, [dtarih] = @dtarih, [tel] = @tel WHERE (([mno] = @Original_mno) AND ((@IsNull_ad = 1 AND [ad] IS NULL) OR ([ad] = @Original_ad)) AND ((@IsNull_soyad = 1 AND [soyad] IS NULL) OR ([soyad] = @Original_soyad)) AND ((@IsNull_dtarih = 1 AND [dtarih] IS NULL) OR ([dtarih] = @Original_dtarih)) AND ((@IsNull_tel = 1 AND [tel] IS NULL) OR ([tel] = @Original_tel)));
SELECT mno, ad, soyad, dtarih, tel FROM musteri WHERE (mno = @mno)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataGridveritabanıişlemleri.Properties.Settings.Default.ticaretConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT mno, ad, soyad, dtarih, tel FROM dbo.musteri";
        ...
        public virtual int Fill(ticaretDataSet.musteriDataTable dataTable) {
        ...
        public virtual ticaretDataSet.musteriDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ticaretDataSet.musteriDataTable dataTable = new ticaretDataSet.musteriDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ticaretDataSet.musteriDataTable dataTable) {
